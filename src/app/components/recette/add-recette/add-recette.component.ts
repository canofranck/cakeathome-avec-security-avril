...
export class AddRecetteComponent implements OnInit {
  ...
  create() {
    ...
    recette.niveaudifficulterecette =
      this.formaddRecette.value.niveaudifficulterecette;
    recette.tempspreparationrecette =
      this.formaddRecette.value.tempspreparationrecette;
    ...
    recette.recettepremiumrecette =
      this.formaddRecette.value.recettepremiumrecette;
